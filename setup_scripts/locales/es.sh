...
export STR_MENU_UNINSTALL="DESINSTALADOR DE APLICACIONES"
...
export STR_UNINSTALLER_TITLE="DESINSTALADOR"
export STR_UNINSTALL_HINT="Seleccione las aplicaciones instaladas que desea eliminar:"
export STR_UNINSTALL_SUCCESS="[+] %s desinstalado correctamente."
export STR_UNINSTALL_FAILED="[!] Error al desinstalar %s."
